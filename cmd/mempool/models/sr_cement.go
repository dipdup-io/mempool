...
type SmartRollupCement struct {
	...
	Source       string `comment:"Address of the account who has sent the operation."                                 index:"sr_cement_source_idx"                                          json:"source,omitempty"`
	Rollup       string `comment:"Smart rollup to which the operation was sent."                                      index:"sr_cement_rollup_idx"                                          json:"rollup"`
	Commitment   string `comment:"Cemented commitment."                                                               json:"commitment"`
}
